...
public class font_chooser implements ActionListener, ListSelectionListener {
    ...
    String font_names[];//fnt name array
    Font sample;
    ...
    public font_chooser(Notepad ref)
    {
        ...
        //font style box
        String style[]={"Regular","Bold","Italic","Bolt Italic"};
        fstyle=new JList(style);
        ...
        fstyle_sc.setBounds(140,10,80,70);
        window.add(fstyle_sc);
        fstyle.addListSelectionListener(this);
        
        //font siz box
        Vector<String> a=new Vector<String>(140,1);
